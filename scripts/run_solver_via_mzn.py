...
status, totalTime, extra = minizinc_solve(modelFile=modelFile, instFile=instFile, solver=solver, timeLimit=timelimit, solvers_to_check=solvers_to_check)
results = {'modelFile': os.path.abspath(modelFile), 'instFile': os.path.abspath(instFile), 'solver': solver, 'status': status, 'time': totalTime, 'extra': extra}
print("\nRun results:")
print(results)   
